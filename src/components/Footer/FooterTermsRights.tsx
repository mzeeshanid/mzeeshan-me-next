...
import { divider, hstack, stack } from "styled-system/patterns";
...
const FooterTermsRights = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className={hstack({ gap: "4", flexWrap: "wrap", justify: "center" })}
      >
      ...
      <hr className={verticalRule} />
      <div
        className={hstack({ gap: "2", flexWrap: "wrap", justify: "center" })}
      >
        <p className={css({ fontSize: "sm", color: "fg.muted" })}>
          {"Powered by"}
        </p>
        <NextLink href={nextJs.url} aria-label="Next.js">
          <NextJsIcon size={20} />
        </NextLink>
        <p className={css({ fontSize: "sm", color: "fg.muted" })}>{"&"}</p>
        <NextLink href={chakraUi.url} aria-label="Chakra UI">
