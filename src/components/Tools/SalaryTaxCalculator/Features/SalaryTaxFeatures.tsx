...
import { salaryTaxFeaturesData } from "@/data/tools/salaryTaxCalculator";
import {
  Box,
  GridItem,
  Heading,
...
const SalaryTaxFeatures: React.FC = () => {
  const { palette } = useColorPalette();
  const data = salaryTaxFeaturesData;
...
export default SalaryTaxFeatures;
