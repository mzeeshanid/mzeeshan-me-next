...
const FreelanceTaxFilingServices: React.FC = () => {
      ...
      <VStack align="stretch" gap={6}>
        <VStack align="flex-start" gap={3}>
          ...
          <Text color="fg.muted" maxW="2xl">
            Even though Section 154A is a final withholding tax, you are still required to file an
            annual income tax return with FBR to stay on the Active Taxpayer List. These third-party
            services can help make the process easy.
          </Text>
        </VStack>
        ...
        <Box p={4} borderRadius="lg" borderWidth="1px" borderColor="border" bg="bg.panel">
...
export default FreelanceTaxFilingServices;
