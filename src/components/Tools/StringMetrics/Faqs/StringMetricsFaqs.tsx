...
import { stringMetricsFaqsData } from "@/data/tools/stringMetrics/stringMetricsFaqs";
import {
  Box,
  Collapsible,
  GridItem,
...
const StringMetricsFaqs: React.FC<Props> = (props: Props) => {
  const { palette } = useColorPalette();
  const faqData = stringMetricsFaqsData;
...
export default StringMetricsFaqs;
