...
export const mzFileManageScreenshotsData: MyAppScreenshotsDataModel = {
    ...
    screenshots: [
        { src: screen1, alt: "MZ File Manage Screenshot 1", width: 300, height: 534 },
        { src: screen2, alt: "MZ File Manage Screenshot 2", width: 300, height: 534 },
        { src: screen3, alt: "MZ File Manage Screenshot 3", width: 300, height: 534 },
        { src: screen4, alt: "MZ File Manage Screenshot 4", width: 300, height: 534 },
        { src: screen5, alt: "MZ File Manage Screenshot 5", width: 300, height: 534 },
        { src: screen6, alt: "MZ File Manage Screenshot 6", width: 300, height: 534 },
        { src: screen7, alt: "MZ File Manage Screenshot 7", width: 300, height: 534 },
        { src: screen8, alt: "MZ File Manage Screenshot 8", width: 300, height: 534 },
        { src: screen9, alt: "MZ File Manage Screenshot 9", width: 300, height: 534 },
    ]
}
