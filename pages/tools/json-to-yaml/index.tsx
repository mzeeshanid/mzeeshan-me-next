...
import JsonToYamlConverter from "@/components/Tools/JsonValidatorFormatter/Hero/JsonToYamlConverter";
...
const meta = jsonConverterTabMetaData.yaml;
const header = jsonConverterTabHeaderData.yaml;
const introData = jsonConverterIntroDataByTab.yaml;
const benefitsData = jsonConverterBenefitsDataByTab.yaml;
const featuresData = jsonConverterFeaturesDataByTab.yaml;
const faqsData = jsonConverterFaqsDataByTab.yaml;
const relatedArticleHeader = jsonConverterRelatedArticleDataByTab.yaml;

const JsonToYamlPage: React.FC<Props> = ({ article }) => (
  <>
    ...
    <Spacer p={8} />
    <Container maxW="6xl">
      <JsonRelatedTools currentToolId="yaml" />
    </Container>
