...
const TermsAndConditionsHome: React.FC<Props> = (props: Props) => {
  ...
  return (
    <>
      ...
      <Container maxW="6xl">
        ...
        <Spacer p={4} />
        <Text color={"fg.muted"}>Last updated: September 08, 2021</Text>
        <Text color={"fg.muted"}>
          Please read these terms and conditions carefully before using Our
          Service.
        </Text>
        <Heading size={{ base: "lg", md: "xl" }} pt={4} pb={2}>
          Interpretation and Definitions
        </Heading>
        <Heading size={{ base: "md", md: "lg" }} pt={2} pb={2}>
          Interpretation
        </Heading>
        <Text color={"fg.muted"}>
        ...
        <List.Root pl={6}>
          ...
          <ListItem>
            <Text color="fg.muted">
              ...
              Agreement) refers to Muhammad Zeeshan.
            </Text>
          </ListItem>
          <ListItem>
            <Text color="fg.muted">
